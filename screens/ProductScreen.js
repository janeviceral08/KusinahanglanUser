...
export default class ProductScreen extends Component{
  ...
  _renderItem = (item, index) => {
    return (
      ...
      >
        <Products title={item["title"]} store={this.state.name} storeId={this.state.store_id} token={this.state.token} slatitude={this.state.slatitude} slongitude={this.state.slongitude} navigation={this.props.navigation}/>
      </View>
    );
  };
