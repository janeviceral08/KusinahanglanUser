...
export default class SignUpScreen extends Component {
  ...
  fetchBarangay =(city)=>{
    this.setState({ selectedCity: city })
        ...
        signup() {
          ...
          if(this.state.userPoint.latitude == null){
            this.setState({hasError: true, errorText: 'Pin your Location!',loading: false});
            return;
          }
    ...
    />
            ...
            <Button onPress={this.myCurrentLocation} style={{backgroundColor: 'red', marginVertical: 20,width: '100%',
                                                                                      height: 50,
                                                                                      justifyContent: 'center',
                                                                                      alignItems: 'center',
                                                                                      borderRadius: 10, borderWidth: 1, borderColor: 'red'}}><Text style={[styles.textSign, {
                                                                                        color:'#fff'
            ...
            <Item>
            <AntDesign name="enviromento" size={20} color={"#687373"}/>
            <Input placeholder='City' onChangeText={(text) => this.fetchBarangay(text)} placeholderTextColor="#687373" />
           ...
           <Item>
            ...
            <Input placeholder='Barangay' onChangeText={(text) => this.setState({selectedBarangay: text})} placeholderTextColor="#687373" />
